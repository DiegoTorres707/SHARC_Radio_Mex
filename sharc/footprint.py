...
if __name__ == '__main__':
    ...
    fprint90 = Footprint(1.9, elevation_deg=90)
    fprint60 = Footprint(1.9, elevation_deg=60)
    fprint45 = Footprint(1.9, elevation_deg=45)
    fprint30 = Footprint(1.9, elevation_deg=30)
    fprint20 = Footprint(1.9, elevation_deg=20)
    #fprint05 = Footprint(1.9, elevation_deg=5)
    ...
    long, lat = fprint60.calc_footprint(n)
    plt.plot(long, lat, 'y', label='$60^o$')
    ...
    #area Geo
    print(
        "Sat at geo km elevation 90 deg: area = {}".format(
            fprint90.calc_area(n),
        ),
    )
    print(
        "Sat at geo km elevation 60 deg: area = {}".format(
            fprint60.calc_area(n),
        ),
    )
    print(
        "Sat at geo km elevation 45 deg: area = {}".format(
            fprint45.calc_area(n),
        ),
    )
    print(
        "Sat at geo km elevation 30 deg: area = {}".format(
            fprint30.calc_area(n),
        ),
    )
    print(
        "Sat at geo km elevation 20 deg: area = {}".format(
            fprint20.calc_area(n),
        ),
    )
#    print(
 #       "Sat at geo km elevation 5 deg: area = {}".format(
  #          fprint05.calc_area(n),
   #     ),
    #)
    ...
    fprint_35786km = Footprint(1.9, elevation_deg=0, sat_height=35786000)
